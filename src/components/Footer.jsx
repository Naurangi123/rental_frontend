...
export default function Footer() {
  return (
    <footer className="bg-pink-900 text-white mt-12 sm:mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          {/* Brand */}
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-pink-600 rounded-lg flex items-center justify-center font-bold">
                R
              </div>
              <span className="text-lg sm:text-xl font-bold">RentKaro</span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2 text-pink-200">
                ...
                <span className="text-sm sm:text-base">info@rentkaro.com</span>
              </div>
              <div className="flex items-center space-x-2 text-pink-200">
        ...
        <div className="border-t border-pink-700 pt-6 sm:pt-8">
          ...
          <p className="text-center text-pink-200 text-xs sm:text-sm mt-4">
            © 2024 RentKano. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
